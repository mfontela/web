...
RREX15 <- read_excel("C:/Users/marco/Seafile/marcosmfontela/Database/RREX15_DATABASE.xlsx")
BOCATS <- read_excel("C:/Users/marco/Seafile/marcosmfontela/Database/DataBaseBOCATS_20161019_forMATLAB.xlsx")
RREX17 <- read_excel("C:/Users/marco/Seafile/marcosmfontela/RREX/RREX 2017/DATA/ALL/RREX2017ffp.xlsx", 
    sheet = "RREX2017_ODV")
F19<-read_excel("C:/Users/marco/Seafile/marcosmfontela/FICARAM/DATA/FICARAM2019_ALL.xlsx")
...
SINES <- read_excel("C:/Users/marco/Seafile/marcosmfontela/EUROFLEETS/SINES/data/SINES EVENTS.xlsx")%>%
...
#movida iconos
  estudios<-makeIcon("C:/Users/marco/Seafile/marcosmfontela/web/map_icons/university_school-512.png", iconWidth = 68, iconHeight = 75,
